...
namespace DataAccess.Migrations
{
    ...
    [Migration("20250811144044_removingTheImageUrlFromProductAndAddingProductImagesToDatabase")]
    partial class removingTheImageUrlFromProductAndAddingProductImagesToDatabase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bulky.Models.OrderHeader", b =>
                {
                    ...
                    b.Property<string>("TrackinNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Bulky.Models.OrderHeader", b =>
                {
                    b.HasOne("Bulky.Models.ApplicationUser", "User")
                        .WithMany()
